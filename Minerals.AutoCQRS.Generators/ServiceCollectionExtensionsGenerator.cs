namespace Minerals.AutoCQRS.Generators
{
    ...
    public class ServiceCollectionExtensionsGenerator : IIncrementalGenerator
    {
        ...
        private static SourceText GenerateStaticClass(ImmutableArray<string> names)
        {
            ...
            AppendStaticClass(builder);
            AppendStaticClassBody(builder, names);
        ...
        private static void AppendStaticClassBody(CodeBuilder builder, ImmutableArray<string> names)
        {
            ...
            {
                builder.WriteLine("collection.AddSingleton<")
                    .Write(name)
                    .Write(">();");
            }
